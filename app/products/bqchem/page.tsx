    ...
    <>
      <section className="relative h-screen flex items-center justify-center">
        ...
        <motion.img
          ...
          src="/assets/images/products/bqchem/img_2.png"
          alt="Molecular Background"
          className="absolute inset-x-0 md:inset-0 md:bottom-0 translate-y-64 md:translate-y-0 w-full h-auto object-cover mask-oval"
        />
        ...
        >
          ...
          <p className="mt-4 text-lg md:text-2xl lg:text-3xl text-white">Quantum chemistry redefined</p>
          <p>8x faster, accurate, and versatile toolkit for drug design, energy, and catalysis</p>
        </motion.div>
      </section>
