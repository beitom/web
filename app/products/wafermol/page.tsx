    ...
    <>
      <section className="relative h-screen flex items-center justify-center">
        ...
        <motion.img
          ...
          src="/assets/images/products/wafermol/img.png"
          alt="Molecular Background"
          className="absolute inset-x-0 md:inset-0 md:bottom-0 translate-y-64 md:translate-y-0 w-full h-auto brightness-50 object-cover mask-oval"
        />
        <motion.div
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <h1 className="rounded-full text-4xl md:text-6xl lg:text-8xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500">
            Wafermol
          </h1>
